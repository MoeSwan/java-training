      ...
      <form:form method="post" action="${pageContext.request.contextPath}/employee/add" modelAttribute="employee">
        <div class="table-responsive">
          <table class="table table-bordered" style="width: 300px">
            ...
            <tr>
              <td>Department :</td>
              <td><form:input type="text" path="dept" />
     ...
     <h3>List of Employees</h3>
       <table class="table table-bordered" style="width: 300px">
         ...
         <tr>
           ...
           <td width="60" align="center"><a href="${pageContext.request.contextPath}/employee/edit/${employee.id}">Edit</a>/<a href="${pageContext.request.contextPath}/employee/delete/${employee.id}">Delete</a></td>
         </tr>
      </c:forEach>
    </table>
  </body>
